...
%--------------------------------------------------------------------------
%
%Function to verify the LC test, by inspecting if we generate the same graph.
%Sometimes, due to having to apply again local gates to put in canonical form, 
%we might not recover exactly the same matrix.
%
%Input: G1: Adjacency matrix of 1st graph
%       G2: Adjacency matrix of 2nd graph  
%       str_sols: The solutions as a string of operations for the LC equivalence
