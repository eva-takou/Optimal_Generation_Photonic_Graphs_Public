function out=create_RGS_missing_connections(core_qubits,ordering,max_leafs,formatOption) %,leafs
...
%To do: Think about re-shuffling the labeling.
...
edges_to_remove = randi(length(EdgeList),1,3); %remove three connections


EdgeList(edges_to_remove)=[];
