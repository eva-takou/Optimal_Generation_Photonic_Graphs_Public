function opt_CNOTs_natural_ordering_RGS
%--------------------------------------------------------------------------
%Created by Eva Takou
%Last modified: June 17, 2024
%--------------------------------------------------------------------------
%
%Find the optimal CNOT counts for un-encoded RGS with natural ordering that
...
figure(2)
Adj=double(create_RGS_natural_ordering(100));
